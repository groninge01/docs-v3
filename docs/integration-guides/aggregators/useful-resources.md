...
* [BufferRouter ABI](/developer-reference/contracts/abi/buffer-router.md)
...
* [BufferRouter API](/developer-reference/contracts/buffer-router-api.md)
...
* [Balancer API docs](/data-and-analytics/data-and-analytics/balancer-api/balancer-api.md)